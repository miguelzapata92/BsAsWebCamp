        ...
        <form id="registro" class="registro" action="index.html" method="post">
            ...
            <div class="resumen clearfix" id="resumen">
                ...
                <div class="caja clearfix">
                    <div class="extras">
                        <div class="orden">
                            <label for="remera_evento">Remera del evento $1000 <small>(Promoción 7% Descuento)</small></label>
                            <input type="number" min="0" id="remera_evento" size="3" placeholder="0">
                        </div>
                        <!--Orden-->


                        <div class="orden">
                            <label for="gorra_evento">Gorra del evento $600 </label>
                            <input type="number" min="0" id="gorra_evento" size="3" placeholder="0">
                        </div>
                        <!--Orden-->
                        <div class="orden">
                            <label for="regalo">Seleccione aquí un regalo</label>
                            <select id="regalo" required>
                                <option value="">Seleccione un regalo</option>
                                <option value="STI">Stickers</option>
                                <option value="PUL">Pulsera</option>
                                <option value="CAR">Cartuchera</option>
                                </select>
                        </div>
                        <!--Orden-->
                    ...
                    <div class="total">
                        ...
                        <input id="btn-registro" class="button" type="submit">
                    </div>
                </div>
                <!--Resumen-->
